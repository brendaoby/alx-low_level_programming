# Makefiles
Project done during **Full Stack Software Engineering** at **ALX** to learn about makefiles, when, why and how to use them (with variables, explicit and implicit rules).
